...
import com.windylee.activity.EditPersonCenter;
import com.windylee.activity.LoginActivity;
import com.windylee.activity.MessageCenter;
import com.windylee.activity.SettingCenter;
...
public class PersonCenterFragment extends Fragment implements OnClickListener {
    ...
    public void initView(View view) {
        ...
        manageService.getUserInfo(Utils.user_id).observeOn(AndroidSchedulers.mainThread())
                .subscribe(
        ...
        Picasso.with(getActivity()).load(Utils.URL + Utils.user_id).into(photoImageView);
