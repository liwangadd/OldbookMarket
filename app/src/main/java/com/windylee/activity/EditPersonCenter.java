        ...
        switch (arg0.getId()) {
            ...
            case R.id.personedit_finish_btn:
                ...
                if (nick.equals("")) {
                    ...
                    doSetUserInfo(Utils.user_id, nick, sex, mobile, qq, wechat);
//				new UserManageService().SetUserInfo(map, this);
    ...
    private void doSetUserInfo(String user_id, final String nick, final int sex, final String mobile, final String qq, final String wechat) {
        OldBookFactory.getManageSingleton().SetUserInfo(user_id, nick, sex, mobile, qq, wechat)
