...
import com.windylee.application.OldBookApplication;
    ...
    public void initView() {
        ...
        if (map != null) {
            ...
            try {
                ...
                if (length > 10) {
                    Picasso.with(this).load(Utils.IMGURL + map.get("imgs").toString().substring(1, 37)).into(bookImageView);
...
//                    map.put("img1", img1);
                    ...
                    doAddWish(Utils.user_id, Utils.username, wishId, wishname, wishdescrip, phone, qq, wechat, type, img1,
                            reward, priceView.getText().toString());
    ...
    private void doAddWish(String user_id, String username, String wishId, String wishname, String wishdescrip,
                           String phone, String qq, String wechat, int type, String img1, int rewrad, String price) {
        wishService.addWish(user_id, type, wishId, wishname, username, wishdescrip, phone,
                qq, wechat, img1, rewrad, price).observeOn(AndroidSchedulers.mainThread())
