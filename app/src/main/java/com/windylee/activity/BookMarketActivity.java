...
import com.windylee.adapter.BookAdapter;
...
//					Toast.makeText(BookMarketActivity.this, "网络连接超时", Toast.LENGTH_SHORT)
//							.show();
//				}
//			}
//		};
...
//		service.getBooksByTypeV1_5(type, Utils.curUniversity, page+"" , audience, order_by, onQueryCompleteListener, BookMarketActivity.this);
        bookService.getBooksByTypeV1_5(type, Utils.curUniversity, page, audience, order_by)
