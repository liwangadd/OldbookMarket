...
//    private final String GETBOOKINFOACTION = "book/getBookInfo";
    ...
    @FormUrlEncoded
    public Observable<String> addBook(@Field("user_id") String userId, @Field("bookname") String bookName, @Field("book_id") String bookId,
                                      @Field("username") String username, @Field("price") double price, @Field("newness") String newness,
                                      @Field("audience_v1_5") String audience, @Field("description") String description, @Field("mobile") String phone,
                                      @Field("qq") String qq, @Field("wexin") String wechat, @Field("img1") String img1, @Field("img2") String img2,
                                      @Field("img3") String img3, @Field("introduction") String introduction, @Field("score") String score,
                                      @Field("tags") String tags, @Field("original_price") String originPrice, @Field("type_v1_5") int type_v1_5);
