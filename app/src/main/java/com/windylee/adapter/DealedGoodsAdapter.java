...
import com.windylee.fragment.MyBooksFragment;
...
public class DealedGoodsAdapter extends BaseAdapter{
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		try {
			...
			Picasso.with(context).load(Utils.IMGURL+imgs).into(item.imageView);
		} catch (Exception e) {
			...
			if(arg0.getId()==R.id.edit_btn){
				...
				.setPositiveButton("是", 
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface arg0, int arg1) {
								// TODO Auto-generated method stub
								doSetBookStatus(Utils.user_id, list.get(position).get("book_id").toString(), 1);
							}
						})  
				...
				.setPositiveButton("是", 
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface arg0, int arg1) {
								// TODO Auto-generated method stub
                                doSetBookStatus(Utils.user_id, list.get(position).get("book_id").toString(), 2);
							}
						})  
				.setNegativeButton("否", null)  
				.show();  
    ...
    private void doSetBookStatus(String user_id, String book_id, int status) {
        centerService.setBookStatus(user_id, book_id, status).observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Action1<String>() {
                    ...
                    public void call(String result) {
                        if(result.equals("success")){
                            ...
                            Toast.makeText(context, "售出失败", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
